...
@Injectable()
export class CgErApiSecurityService {
  /**
  ...
  async CreateDir(strReadPath: any, tabPath: any, userMatrix: any) {
    try {
      ...
      for (let i = 0; i < tables.length; i++) {
        ...
        await this.CommonService.CreateSchemaFile(
          './src/cg-AppTemplate/cg-er-api-security-json/service.ejs',
          column,
          tabName,
        ...
        await this.CommonService.CreateFileWithThreeParam(
          './src/cg-AppTemplate/cg-er-api-security-json/controller.ejs',
          column,
          tabName,
          userMatrix,
          '',
        ...
        await this.CommonService.CreateSchemaFile(
          './src/cg-AppTemplate/cg-er-api-security-json/enitity.ejs',
          columnForEntity,
          tabName,
          tabPath +
            '/' +
        ...
        await this.CommonService.CreateSchemaFile(
          './src/cg-AppTemplate/cg-er-api-security-json/module.ejs',
          '',
          tabName,
          tabPath + '/' + tabName + '/' + tabName + '.module.ts',
        );
        await this.CommonService.CreateSchemaFile(
          './src/cg-AppTemplate/cg-er-api-security-json/app.module.ejs',
          tables,
          '',
      ...
      await this.CommonService.CreateSchemaFile(
        './src/cg-AppTemplate/cg-er-api-security-json/defaultEntity.ejs',
        'default_Id',
        'default',
